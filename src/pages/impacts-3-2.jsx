...
const Impact = () => {
  ...
  return (
    <>
      ...
      <CompletionCard completeImage="/building.png" completeTask={completeTask} completeMessage="You've unlocked a tip!" completeFact="Try to shop locally more often than not, as emissions from transportation contributes to the melting of our ice caps and the expansion of our oceans."/>
