...
const IntroPage = ({ pageColor }) => {
  ...
  return (
    <div>
      <div
        style={{
          // Serves as background for the page //
          display: 'flex',
      ...
      >
        ...
        <RoundBlueButtonContainer mySwitch={mySwitch} setMySwitch={setMySwitch}>
          {mySwitch
            ? ((RoundBlueButton.bgColor = 'white'),
              (RoundBlueButton.color = colors.blue))
            : ((RoundBlueButton.backgroundColor = colors.blue),
              (RoundBlueButton.color = 'white'))}
